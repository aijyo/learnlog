...
cmake -S . -B build `
  ...
  修改 cmakelists set(OpenCV_DIR "D:/3rd/opencv/sources/build/install/lib")：
...
if (WIN32)
  ...
  # Support both vcpkg layout (share/opencv4) and official OpenCV build layout (x64/vc16/lib).
  if (WIN32)
  message(STATUS "OPENCV_DIR: ${OPENCV_DIR}")
	if (EXISTS "${OPENCV_DIR}/OpenCVConfig.cmake")
		# vcpkg style: .../share/opencv4
		set(OpenCV_DIR "${OPENCV_DIR}")
		message(STATUS "OPENCV_DIR EXISTS: ${OPENCV_DIR}")
	else()
		# official OpenCV build style: OPENCV_DIR is the OpenCV root folder
		set(OpenCV_DIR "${OPENCV_DIR}/x64/vc16/lib")
	endif()
	set(OpenCV_DIR "D:/3rd/opencv/sources/build/install/lib")
	find_package(OpenCV REQUIRED)
	endif()
  if(USE_FREETYPE)
...
# add_library(ppocr_sdk SHARED
  # ppocr_dll.cpp
# )
# target_compile_definitions(ppocr_sdk PRIVATE PPOCR_DLL_EXPORTS)
