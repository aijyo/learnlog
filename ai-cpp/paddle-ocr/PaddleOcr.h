...
//        // Each dir should contain inference.json + inference.pdiparams (PP-OCRv5 static_infer export), or model.pdmodel + model.pdiparams (legacy), or __model__ + __params__ (older legacy).
//        std::string det_model_dir;
//        std::string rec_model_dir;
//        std::string cls_model_dir;  // optional, can be empty
//        std::string rec_dict_path;  // dict txt OR inference.yml/yaml containing PostProcess.character_dict
//
//        // English:
//        // Runtime settings
//        bool use_gpu = false;
